  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>Send updates, marketing materials, and other communications</li>
      </ul>

      <h2 className="mt-4">3. Sharing Your Information</h2>
      <p>
        We do not share your information with third parties except as necessary
        to comply with legal obligations, enforce our policies, or protect our
        rights.
      </p>

      <h2 className="mt-4">4. Cookies</h2>
      <p>
